package com.mytest.utils.security.rsa;
...
public class RSA {
	...
	/**
	 * 生成RSA密钥对
	 * @return 返回密钥组，Map<String, String>类型。其中publicKey为公钥，privateKey为私钥，modulus为模
	 * @throws Exception
	 */
	 ...
	 * RSA加密方法 
	 * 
	 * @param source 源数据，加密前明文
	 * @param publicKey 字符型公钥
	 * @return Base64转换后的加密结果
	 * @throws Exception
	 */
	public static String encryptToBase64(String source, String publicKey) throws Exception {
		return encryptToBase64(source, publicKey, ConfigureEncryptAndDecrypt.CHAR_ENCODING);
	}
	 ...
	 * @throws Exception
	 */
	public static String encryptToBase64(String source, String publicKey, String charset) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static String encryptToBase64(String source, PublicKey key) throws Exception {
		return encryptToBase64(source, key, ConfigureEncryptAndDecrypt.CHAR_ENCODING);
	}
	 ...
	 * @param source 源数据，加密前明文
	 * @param key 公钥
	 * @param charset 加密明文字符集类型
	 * @return
	 * @throws Exception
	 */
	public static String encryptToBase64(String source, PublicKey key, String charset) throws Exception {
	...
	/**
	 * RSA解密算法
	 * @param cryptograph Base64格式的密文
	 * @param privateKey 字符型私钥
	 * @return
	 * @throws Exception
	 */
	public static String decryptFromBase64(String cryptograph, String privateKey )
			throws Exception {
		return decryptFromBase64(cryptograph, privateKey, ConfigureEncryptAndDecrypt.CHAR_ENCODING);
	}
	 ...
	 * @throws Exception
	 */
	public static String decryptFromBase64(String cryptograph, String privateKey, String charset)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public static String decryptFromBase64(String cryptograph, PrivateKey key) throws Exception {
		return decryptFromBase64(cryptograph, key, ConfigureEncryptAndDecrypt.CHAR_ENCODING);
	}
	 ...
	 * @throws Exception
	 */
	public static String decryptFromBase64(String cryptograph, PrivateKey key, String charset) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static byte[] decrypt(byte[] cryptograph, PrivateKey key) throws Exception {
	...
	public static PublicKey getPublicKey(String key, String charset) throws Exception {
		X509EncodedKeySpec keySpec = new X509EncodedKeySpec(Base64.decodeBase64(key.getBytes(charset)));
	...
	public static PrivateKey getPrivateKey(String key, String charset) throws Exception {
		PKCS8EncodedKeySpec keySpec = new PKCS8EncodedKeySpec(Base64.decodeBase64(key.getBytes(charset)));
		KeyFactory keyFactory = KeyFactory.getInstance("RSA");
	...
	public static String sign(String content, String privateKey) {
		...
		try {
			...
			log.error("RSA Sign Error! content:["+content+"] privateKey:["+privateKey+"]",e);
		}
		return null;
	}
	...
	public static boolean checkSign(String content, String sign, String publicKey)
	{
		...
		{
			log.error("RSA CheckSign Error! content:["+content+"] sign:["+sign+"] publicKey:["+publicKey+"]",e);
		}
