...
import com.mytest.utils.StringArrayUtils;

/**
 * ANSI X9.9 MACУ���㷨
 * 
 * DES���ܽ�� des key = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08}; des
 * data = {0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37}; des result = 1b 18
 * b9 7a 85 f9 67 e9
 * 
 * MAC���ܽ�� mac key = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08}; mac
 * data = {0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x30,
 * 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37}; mac result = a1 e8 02 aa 02 74 74
 * bb
 * 
 * <p>
 * Title: Excel Report Util
 * </p>
 * <p>
 * Description: report utilitity using JXL
 * </p>
 * <p>
...
public class MessageAuthenticationCode {
	...
	/**
	 * DES���ܴ��� ע�⣺�㷨����ʹ��"DES/ECB/NoPadding"���ܲ���8bytes�ļ��ܽ��
	 * 
	 * @param key
	 * @param data
	 * @return
	...
	public static byte[] desDecryption(byte[] key, byte[] data)
		...
		// StringArrayUtil.byte2hex(decrypted));
	...
	public static byte[] des3DecryptionEcb(byte[] key, byte[] data)
			throws NoSuchPaddingException, NoSuchAlgorithmException,
			InvalidKeyException, BadPaddingException,
			IllegalBlockSizeException, IllegalStateException {
		final String Algorithm = "DESede"; // ���� �����㷨,����
	...
	public static void main(String[] args) throws InvalidKeyException,
		...
		byte[] keyb = StringArrayUtils.hex2byte(key, key.length());
		String iv = "9df131b13df6bdfe";
		byte[] ivb = StringArrayUtils.hex2byte(iv, iv.length());
		...
		System.out.println("en=" + StringArrayUtils.byte2hex(temp_bytes));

		byte[] decrptBytes = des3Decryption(keyb, ivb, StringArrayUtils
				.hex2byte("da0dde2d75cef459faa40a068232cd2eaddf0c7bcd7ef53d",
		...
		String tempMD5 = "PICODE=PI00001CARDDATA="
				+ StringArrayUtils.byte2hex(temp_bytes) + md5key;
